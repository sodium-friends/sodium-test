...
module.exports = function (sodium) {
  ...
  test('crypto_stream_xor_instance', { skip: !sodium.crypto_stream_xor_instance }, function (t) {
    ...
    const inst = sodium.crypto_stream_xor_instance(nonce, key)
  ...
  test('crypto_stream_xor_instance long stream', { skip: !sodium.crypto_stream_xor_instance }, function (t) {
    ...
    const encrypt = sodium.crypto_stream_xor_instance(nonce, key)
    const decrypt = sodium.crypto_stream_xor_instance(nonce, key)
    const plain = []
    const encrypted = []
    const decrypted = []
  ...
  test('crypto_stream_chacha20_xor', function (t) {
    const message = Buffer.from('Hello, World!')
    const nonce = random(sodium.crypto_stream_chacha20_NONCEBYTES)
    const key = random(sodium.crypto_stream_chacha20_KEYBYTES)
  ...
  test('crypto_stream_chacha20_xor_instance', { skip: !sodium.crypto_stream_chacha20_xor_instance }, function (t) {
    ...
    const inst = sodium.crypto_stream_chacha20_xor_instance(nonce, key)
  ...
  test('crypto_stream_chacha20_xor_instance long stream', { skip: !sodium.crypto_stream_chacha20_xor_instance }, function (t) {
    ...
    const encrypt = sodium.crypto_stream_chacha20_xor_instance(nonce, key)
    const decrypt = sodium.crypto_stream_chacha20_xor_instance(nonce, key)
    const plain = []
    const encrypted = []
    const decrypted = []
  ...
  test('crypto_stream_chacha20_ietf_xor_instance', { skip: !sodium.crypto_stream_chacha20_ietf_xor_instance }, function (t) {
    ...
    const inst = sodium.crypto_stream_chacha20_ietf_xor_instance(nonce, key)
  ...
  test('crypto_stream_chacha20_ietf_xor_instance long stream', { skip: !sodium.crypto_stream_chacha20_ietf_xor_instance }, function (t) {
    ...
    const encrypt = sodium.crypto_stream_chacha20_ietf_xor_instance(nonce, key)
    const decrypt = sodium.crypto_stream_chacha20_ietf_xor_instance(nonce, key)
    const plain = []
    const encrypted = []
    const decrypted = []
